...
$res = mysql_query("SELECT * FROM mstock WHERE stockID = '$stockID' AND status = 1");
...
?>
  ...
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
		  ...
		  STOCK HISTORY <?php echo $row[stockName];?></h4>
      <div class="row mb-2">
          <div class="col">
...
var itemTable = $('#itemTable').DataTable(
    {
        ...
        responsive : true,
        ajax: {
            url: "histories_data.php?stockID=<?php echo $_GET[stockID];?>",
            data: 'data'
        },
        columns: [
            { data: 'no' },
...
$("#add").click(function(){
    location.replace('stock_input.php');
});
