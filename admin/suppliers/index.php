    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2">
          ...
          <div class="">
            ...
            <button type='button' id='add' class='btn btn-primary' style='float: right;margin-top:13px; font-size:13px;'>ADD NEW SUPPLIERS</button>
          </a>
          </div>
          <div class="col">
            <h1 class="m-0 text-dark text-center"></h1>
        ...
        <table class='table' id='itemTable' style='font-size:13px;'>
          <thead>
            <tr>
              ...
              <th style='vertical-align:middle;'>SUPPLIER ADDRESS</th>
              <th style='vertical-align:middle;'>SUPPLIER PHONE</th>
