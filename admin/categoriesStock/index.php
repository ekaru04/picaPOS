...
if (!isset($_SESSION["username"])) 
{
  ...
  <div>
    ...
    <div class="container-fluid">
      ...
      <h4 align='center'>CATEGORIES STOCK</h4>
      <div class="row mb-2">
          <div class="col">
          ...
          <div class="">
            ...
            <button type='button' id='add' class='btn btn-primary' style='float: right;margin-top:13px; font-size:13px;'>ADD NEW CATEGORIES</button>
          </a>
          </div>
          <div class="col">
            <h1 class="m-0 text-dark text-center"></h1>
...
var itemTable = $('#itemTable').DataTable(
    {
        ...
        responsive : true,
        ajax: {
            url: "catStock_data.php",
            data: 'data'
        },
        columns: [
            { data: 'no' },
            { data: 'categoryStockName' },
            { data: 'categoryStockCode' },
            { data: 'remarks' },
            { data: 'status' },
            { data: 'lastChanged' },
            { data: 'action'}
...
$("#add").click(function(){
    location.replace('catStock_input.php');
});
