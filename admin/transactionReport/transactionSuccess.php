...
<div>
    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2">
          ...
          <div class="">
            <button type='button' id='canceled' class='btn btn-danger mr-1' style='float: right;margin-top:13px; font-size:13px;'>TRANSACTION CANCELED</button>
            ...
            <button type='button' id='success' class='btn btn-success mr-1' disabled style='float: right;margin-top:13px; font-size:13px;'>TRANSACTION SUCCESS</button>
          </div>
          <div class="col">
            <h1 class="m-0 text-dark text-center"></h1>
            <hr>
