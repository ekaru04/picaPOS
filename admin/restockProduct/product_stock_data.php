...
$query = "SELECT p.productName, ts.tempStock, ts.dateCreated, ts.lastChanged FROM mproduct p INNER JOIN tabtempstock ts ON ts.productID = p.productID";
...
while ($row=mysql_fetch_array($res)){
    ...
    $nestedData[tempStock] = $row["tempStock"];
