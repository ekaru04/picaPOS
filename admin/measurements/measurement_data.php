...
$query = "SELECT * FROM mmeasurement where status != 0";
...
while ($row=mysql_fetch_array($res)){
    ...
    $nestedData[measurementCode] = $row["measurementCode"];
    ...
    $nestedData[action] = "<a href='measurement_input.php?measurementID=$row[measurementID]'>EDIT</a>";
