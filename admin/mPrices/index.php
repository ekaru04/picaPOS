...
if (!isset($_SESSION["username"])) 
{
  ...
  <div>
    ...
    <div class="container-fluid">
      ...
      <h4 align='center'>MASTER DATA PRICE</h4>
      <div class="row mb-2">
          <div class="col">
          ...
          <div class="">
            ...
            <button type='button' id='add' class='btn btn-primary' style='float: right;margin-top:13px; font-size:13px;'>ADD NEW MASTER PRICE</button>
          </a>
          </div>
          <div class="col">
            <h1 class="m-0 text-dark text-center"></h1>
