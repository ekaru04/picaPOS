...
$query = "SELECT * FROM mloyalty WHERE status != 0 ORDER BY dateCreated ASC";
...
while ($row=mysql_fetch_array($res)){
    ...
    $nestedData[no] = $x;
    $nestedData[requirement] = $row['requirement'];
    ...
    $nestedData[action] = "<a href='loyal_input.php?loyalID=$row[loyalID]'>EDIT</a>";
