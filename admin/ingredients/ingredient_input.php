...
if($_GET['ingredientID']==""){
    $queryItemID = "SELECT count(ingredientID)+1 as ingredientID FROM mingredient";
    $resItemID = mysql_query($queryItemID);
    $row = mysql_fetch_array($resItemID);
    $ingredientID = $row['ingredientID'];
}else{
    $ingredientID = $_GET['ingredientID'];
    $query = "SELECT * FROM mingredient WHERE ingredientID ='$ingredientID'";
...
<div class="">
		...
		<div class="container-fluid">
			<div class='entry-box-basic'>
                <h1>
                    <a href='/picaPOS/admin/ingredients' style='text-decoration:none;color:black;'><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
...
echo "<button type='button' id='del' style='border:none;background-color:rgba(255, 255, 255, 0);'>
        ...
        <path fill-rule='evenodd' d='M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z'/>
                ...
                <form id='formAdd' method='POST' action='ingredient_process.php'>
                    <div class='row mt-2'>
                        <div class='col'>
                            <input type='hidden' class='type-input' name='ingredientID' value='<?php echo $ingredientID; ?>'/>
                        </div>
					</div>

					<div class='row  mt-3 '>
                        <div class='col-2 label'>
                           <input type='text' class='form-control-plaintext' disabled value='INGREDIENT NAME' />
                        </div>
                        <div class='col-4'>
                            <input type='text' class='type-input form-control' name='ingredient' placeholder='Ingredient Name' style='width:300px' value='<?php echo $row[ingredient]; ?>' required />
                        </div>
					</div>
                ...
                <?php } ?>
					...
					<div class='row  mt-3 '>
                        ...
                        <div class='col-4'>
                            <input type='text' class='type-input form-control' name='minStock' placeholder='Ingredient Stock' style='width:300px' value='<?php echo round($row[minStock]); ?>' required />
                        </div>
					</div>
...
<script type="text/javascript">
	...
	$("#cancel").click(function(){
        ...
        location.replace('/picaPOS/admin/ingredients/');
    });
