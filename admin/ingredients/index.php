    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2">
          ...
          <div class="">
            ...
            <button type='button' id='add' class='btn btn-primary' style='float: right;margin-top:13px; font-size:13px;'>ADD NEW INGREDIENTS</button>
          </a>
          </div>
          <div class="col">
            <h1 class="m-0 text-dark text-center"></h1>
