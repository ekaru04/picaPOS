...
$res = mysql_query("SELECT * FROM mIngredient WHERE ingredientID = '$ingredientID' AND status = 1");
...
?>
  ...
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
		  ...
		  INGREDIENTS HISTORY <?php echo $row[ingredient];?></h4>
      <div class="row mb-2">
          <div class="col">
...
var itemTable = $('#itemTable').DataTable(
    {
        ...
        responsive : true,
        ajax: {
            url: "history_data.php?ingredientID=<?php echo $_GET[ingredientID];?>",
            data: 'data'
        },
        columns: [
            { data: 'no' },
