		...
		// exit;
			...
			$ingredientNewStock = $ingredientCurStock-$requestAmount;
				...
				if($ingredientNewStock < $ingredientMinStock || $ingredientNewStock < 0){
					...
					$queryT = "INSERT INTO tabitemhistory(id,transType,ingredientID,amount,itemAmount,measurementID,cost,userID,status,dateCreated,lastChanged) VALUES('$journalID', 'OUT', '$fetchRequestDetail[ingredientID]', '$requestAmount', '$ingredientNewStock','$fetchRequestDetail[measurementID]','$duitTotal','$user', 1, '$dateCreated', '$lastChanged')";						
