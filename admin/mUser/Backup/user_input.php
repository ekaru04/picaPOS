...
echo "<button type='button' id='del' style='border:none;background-color:rgba(255, 255, 255, 0);'>
        ...
        <path fill-rule='evenodd' d='M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z'/>
                ...
                <form id='formAdd' method='POST' action='user_process.php'>
                    <div class='row mt-1'>
                        <div class='col'>
                            <input type='hidden' class='type-input' name='userID' value='<?php echo $userID; ?>'/>
                        </div>
					</div>
                    ...
                    <div class='row  mt-1 '>
                        ...
                        <div class='col' style='margin-left:-120px;'>
							<input type='checkbox' class='type-input' id='activeFlag' name='activeFlag'/>
					...
					<div>
						...
						<div class='row mt-3'>
							<div class='col-3'>
                            	<h5>OPERATIONAL</h5>
                            	<input type='checkbox' class='type-input ch ops' name='ops1' id='ops1'/>
								<label for='ops1' style='font-weight:normal;'>POS</label><br/>
								
                            	<input type='checkbox' class='type-input ch ops' name='ops2' id='ops2'/>
								<label for='ops2' style='font-weight:normal;'>Order List</label><br/>
								
                            	<input type='checkbox' class='type-input ch ops' name='ops3' id='ops3'/>
							...
							<div class='col-3'>
                            	<h5>TRANSACTION</h5>
                            	<input type='checkbox' class='type-input ch trx' name='trx1' id='trx1'/>
								<label for='trx1' style='font-weight:normal;'>Restock Ingredient</label><br/>
								
                            	<input type='checkbox' class='type-input ch trx' name='trx2' id='trx2'/>
								<label for='trx2' style='font-weight:normal;'>Production Input</label><br/>
								
                            	<input type='checkbox' class='type-input ch trx' $trx3 name='trx3' id='trx3'/>
								<label for='trx3' style='font-weight:normal;'>In/Out Products</label><br/>
								
                            	<input type='checkbox' class='type-input ch' id='allTrx' $allTrx name='allTrx'/>
								<label for='allTrx' style='font-weight:normal;'>All Transaction Menu</label><br/>
							</div>
							<div class='col-3'>
                            	<h5>MASTER DATA</h5>
                            	<input type='checkbox' class='type-input ch mas' $mas1 name='mas1' id='mas1'/>
								<label for='mas1' style='font-weight:normal;'>Categories</label><br/>
								
                            	<input type='checkbox' class='type-input ch mas' $mas2 name='mas2' id='mas2'/>
								<label for='mas2' style='font-weight:normal;'>Measurement</label><br/>
								
                            	<input type='checkbox' class='type-input ch mas' $mas3 name='mas3' id='mas3'/>
								<label for='mas3' style='font-weight:normal;'>Payment Method</label><br/>
								
                            	<input type='checkbox' class='type-input ch mas' $mas4 name='mas4' id='mas4'/>
								<label for='mas4' style='font-weight:normal;'>Supplier</label><br/>
								
                            	<input type='checkbox' class='type-input ch mas' $mas5 name='mas5' id='mas5'/>
								<label for='mas5' style='font-weight:normal;'>Promo</label><br/>
								
                            	<input type='checkbox' class='type-input ch mas' $mas6 name='mas6' id='mas6'/>
								<label for='mas6' style='font-weight:normal;'>Vouchers</label><br/>
								
                            	<input type='checkbox' class='type-input ch' id='allMas' $allMas name='allMas'/>
						...
						<div class='row mt-3'>
							<div class='col-3'>
                            	<h5>STOCK</h5>
                            	<input type='checkbox' class='type-input ch stk' $stk1 name='stk1' id='stk1'/>
								<label for='stk1' style='font-weight:normal;'>Ingredients</label><br/>
								
                            	<input type='checkbox' class='type-input ch stk' $stk2 name='stk2' id='stk2'/>
								<label for='stk2' style='font-weight:normal;'>Recipes</label><br/>
								
                            	<input type='checkbox' class='type-input ch stk' $stk3 name='stk3' id='stk3'/>
								<label for='stk3' style='font-weight:normal;'>Products</label><br/>
								
                            	<input type='checkbox' class='type-input ch' id='allStk' $allStk name='allStk'/>
								<label for='allStk' style='font-weight:normal;'>All Stock Menu</label><br/>
							</div>
							<div class='col-3'>
                            	<h5>REPORTS</h5>
                            	<input type='checkbox' class='type-input ch rpt' $rpt1 name='rpt1' id='rpt1'/>
								<label for='rpt1' style='font-weight:normal;'>Sales</label><br/>
								
                            	<input type='checkbox' class='type-input ch rpt' $rpt1 name='rpt2' id='rpt2'/>
								<label for='rpt2' style='font-weight:normal;'>Production</label><br/>
								
                            	<input type='checkbox' class='type-input ch' id='allRpt' $allRpt name='allRpt'/>
								<label for='allRpt' style='font-weight:normal;'>All Report Menu</label><br/>
							</div>
							<div class='col-3'>
                            	<h5>MANAGEMENT</h5>
                            	<input type='checkbox' class='type-input ch mgt' $mgt1 name='mgt1' id='mgt1'/>
								<label for='mgt1' style='font-weight:normal;'>Outlet</label><br/>
								
                            	<input type='checkbox' class='type-input ch mgt' $mgt2 name='mgt2' id='mgt2'/>
								<label for='mgt2' style='font-weight:normal;'>User</label><br/>
								
                            	<input type='checkbox' class='type-input ch mgt' $mgt3 name='mgt3' id='mgt3'/>
								<label for='mgt3' style='font-weight:normal;'>Departement</label><br/>
								
                            	<input type='checkbox' class='type-input ch mgt' $mgt3 name='mgt4' id='mgt4'/>
								<label for='mgt4' style='font-weight:normal;'>Position</label><br/>
								
                            	<input type='checkbox' class='type-input ch' id='allMgt' $allMgt name='allMgt'/>
