...
if($_GET['closeID']==""){
    ...
    $query = "SELECT c.*,u.fullname,o.outletName FROM tabCloseCashierHeader c INNER JOIN mUser u ON u.userID = c.userID INNER JOIN mOutlet o ON o.outletID = c.outletID WHERE c.closeID ='$closeID'";
    $res = mysql_query($query);
    $row = mysql_fetch_array($res);
  ...
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                ...
                <form id='formClose' method='POST' action='close_process.php'>
					...
					<div class='row mt-1'>
                        ...
                        <div class='col-4'>
                            <input type='text' class='form-control' id='grandTotal' style='width:300px' value='<?php echo $grandTot; ?>'readonly  />
...
echo			   "<div class='row mt-1 '>
                        ...
                        <div class='col-4'>
							...
							<input type='text' name='grandTotals' id = 'Meth_".$payID."'>
                        </div>
					</div>";
					}
