...
$query = "SELECT c.closeID,c.closeDate,c.closePeriode,c.closeShift,c.grandTotal, c.totalReceived, u.fullname,c.lastChanged FROM tabCloseCashierHeader c 
INNER JOIN muser u ON c.userID = u.userID WHERE c.status = 1 AND c.outletID = '$_SESSION[outletID]' ORDER BY c.lastChanged";
...
while ($row=mysql_fetch_array($res)){
    ...
    $nestedData[totalReceived] = $row["totalReceived"];
