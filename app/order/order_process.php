...
$countArr = count($productID);
	...
	if($status == 0){
		...
		$query = mysql_query("UPDATE taborderheader SET orderAmount='$orderAmount', status='0', remarks='$remarks',
		...
		// 				promoID = '$promoID', paymentAmount='$paymentAmount', paymentMethod='$paymentMethod', status='0', remarks='$remarks',
		// 				lastChanged='$lastChanged'
		// 				WHERE orderID = '$orderID' AND outletID = '$outletID'");
		}
		/* END */	
		...
		// $query = mysql_query("UPDATE taborderheader SET orderAmount='$orderAmount',	dpp='$dpp',	discountPrice='$discountPrice',	total='$total',
		// 						promoID = '$promoID', paymentAmount='$paymentAmount', paymentMethod='$paymentMethod', status='1', remarks='$remarks', 
		// 						lastChanged='$lastChanged'
		// 				  	WHERE orderID = '$orderID' AND outletID = '$outletID'");
		}
		/* END */	
